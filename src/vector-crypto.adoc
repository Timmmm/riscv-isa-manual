...
Operation::
+
sail::execute[clause="VWSLL_VV(_, _, _, _)",part=body,unindent]
+
sail::execute[clause="VWSLL_VX(_, _, _, _)",part=body,unindent]
+
sail::execute[clause="VWSLL_VI(_, _, _, _)",part=body,unindent]
